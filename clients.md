...
| Client             | Install                                                                       |
| ------------------ | ----------------------------------------------------------------------------- |
| **Claude Code**    | `claude mcp add finch -s user -- npx -y @finchagentic/mcp@4.6.5 finch-mcp` |
...
| **Hermes**         | `hermes mcp add finch -- npx -y @finchagentic/mcp@4.6.5 finch-mcp`         |
...
* Pin version in every entry (`@finchagentic/mcp@4.6.5`)

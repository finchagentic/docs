...
| Client             | Install                                                                       |
| ------------------ | ----------------------------------------------------------------------------- |
| **Claude Code**    | `claude mcp add finch -s user -- npx -y -p @finchagentic/mcp@4.6.2 finch-mcp` |
...
| **Hermes**         | `hermes mcp add finch -- npx -y -p @finchagentic/mcp@4.6.2 finch-mcp`         |
...
* Pin version in every entry (`@finchagentic/mcp@4.6.2`)
